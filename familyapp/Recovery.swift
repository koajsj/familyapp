...
final class RecoveryFlow {
    ...
    init(publicAPI: any RemoteRecoveryAPI, authenticatedAPI: (any RemoteRecoveryAuthenticatedAPI)? = nil, credentials: (any RemoteCredentialStore)? = nil, installationID: String) {
