...
enum FamilyIntentRoute: String, Sendable, Equatable {
    case todayTimetable
    case commonFree
    case newAgenda
    case reportLocation
...
private protocol FamilyRoutingIntent: AppIntent {
...
struct TodayTimetableIntent: FamilyRoutingIntent {
...
struct CommonFreeIntent: FamilyRoutingIntent {
...
struct NewAgendaIntent: FamilyRoutingIntent {
...
struct ReportLocationIntent: FamilyRoutingIntent {
...
struct ReportSafetyIntent: FamilyRoutingIntent {
...
struct FamilyAppShortcuts: AppShortcutsProvider {
